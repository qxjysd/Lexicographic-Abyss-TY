...
public class AndroidLauncher extends AndroidApplication {
	...
	protected void onCreate (Bundle savedInstanceState) {
		...
		Button.longClick = ViewConfiguration.getLongPressTimeout()/1000f;
						...
						// 使用模拟广告（禁用真实Dirichlet Ad SDK）
		// 如需启用，取消下面注释
		// com.shatteredpixel.shatteredpixeldungeon.ads.AdManager.setImpl(
		// 	new com.shatteredpixel.shatteredpixeldungeon.android.AndroidAdManager(this)
		// );
		// com.shatteredpixel.shatteredpixeldungeon.ads.AdManager.init();
