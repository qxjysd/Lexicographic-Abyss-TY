...
public enum Rankings {
	...
	public void saveGameData(Record rec){
		...
		//include potentially worn misc items and rings
		for (KindofMisc m : belongings.misc) {
			if (m != null) belongings.backpack.items.add(m);
		}
		for (Ring r : belongings.ring) {
			if (r != null) belongings.backpack.items.add(r);
		}
