...
public class AboutScene extends PixelScene {
	...
	public void create() {
		...
		addLine(freesound.bottom() + 4, content);
				...
				//*** Lexicographic-Abyss Credits ***

				CreditsBlock mod = new CreditsBlock(true,
						Window.SHPX_COLOR,
						"Lexicographic-Abyss",
						Icons.SHPX.get(),
						"二次创作作者：_许玄_\nBased on Shattered Pixel Dungeon by _00-Evan_ (Evan Debenham)\n\n" +
						...
						"for more details.",
						"Source Code",
						"https://github.com/qxjysd/Lexicographic-Abyss-TY");
				mod.setRect(freesound.left(), freesound.bottom() + 10, colWidth, 0);
				content.add(mod);

				//*** Supporting Shattered Pixel Dungeon ***

				CreditsBlock patreon = new CreditsBlock(false,
						Window.SHPX_COLOR,
						"Support Shattered Pixel Dungeon:",
						Icons.SHPX.get(),
						"If you enjoy this mod, please consider supporting\n" +
						"the original Shattered Pixel Dungeon on Patreon:\n" +
						"_Evan Debenham_",
						"Patreon",
						"https://www.patreon.com/ShatteredPixel");
				patreon.setRect(mod.left() + colWidth/2f, mod.bottom() + 8, colWidth/2f, 0);
				content.add(patreon);

				addLine(patreon.bottom() + 4, content);

				content.setSize( fullWidth, patreon.bottom()+10 + insets.bottom );
