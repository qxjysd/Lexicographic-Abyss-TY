...
public class Statistics {
	...
	public static int[] bossScores = new int[20];
	public static int totalBossScore;
	public static int[] questScores = new int[20];
	...
	// 每日激励广告观看次数（每天限3次）
	public static int adsWatchedToday;
	...
	public static void reset() {
		...
		exploreScore    = 0;
		bossScores      = new int[20];
		totalBossScore  = 0;
		questScores     = new int[20];
		totalQuestScore = 0;
		winMultiplier   = 1;
		chalMultiplier  = 1;
		totalScore      = 0;
	...
	private static final String ADS_WATCHED = "adsWatchedToday";
	...
	public static void storeInBundle( Bundle bundle ) {
		...
		bundle.put( ADS_WATCHED, adsWatchedToday );
	...
	public static void restoreFromBundle( Bundle bundle ) {
		...
		adsWatchedToday = bundle.getInt( ADS_WATCHED );
